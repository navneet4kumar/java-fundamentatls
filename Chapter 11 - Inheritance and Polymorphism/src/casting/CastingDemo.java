...
public class CastingDemo {
    ...
    public static void displayObject(Object object) {
        if(object instanceof CircleFromSimpleGeometricObject) {
            System.out.println("The circle area " + ((CircleFromSimpleGeometricObject) object).getArea());
            System.out.println("The circle diameter " + ((CircleFromSimpleGeometricObject) object).getDiameter());
