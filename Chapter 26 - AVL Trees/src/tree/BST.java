...
//    protected void inorder(tree.TreeNode<E> root) {
//        if (root == null) return;
//        inorder(root.left);
...
//    }
    ...
    public void inorder() {
        if (root == null) {
            System.out.println("tree.Tree is empty.");
            return;
        }
...
//    }
//
//    protected void postorder(tree.TreeNode<E> root) {
//        if (root == null) return;
//        postorder(root.left);
...
//    protected void preorder(tree.TreeNode<E> root) {
//        if (root == null) return;
//        System.out.print(root.element + " ");
//        preorder(root.left);
//        preorder(root.right);
